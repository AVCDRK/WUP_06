...
$H_0$ The Null Hypothesis is that there is no relationship belief in the (BIGBANG) theory and belief in in the afterlife (POSTLIFE).

$H_0$ The alternative hypothesis is that there is relationship between belief in the after (POSTLIFE).
